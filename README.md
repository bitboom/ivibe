...
목표는 단순한 디자인 취향이 아니라 Apple Human Interface Guidelines와 iOS SDK 문서에 근거한 좋은 예/나쁜 예와 SwiftUI 실습 흐름을 제공하는 것입니다.
...
- [x] Navigation Bar / Title / Toolbar 글 작성
...
- [x] Loading / Empty / Error State 글 작성
- [x] iOS 26 Simulator 실제 스크린샷을 Feedback 글에 반영
- [x] Accessibility 기본 글 작성
- [x] iOS 26 Simulator 실제 스크린샷을 Accessibility 글에 반영
